...
/*****************************电视墙 end******************************/
    ...
    public static final int COMM_GISINFO_UPLOAD = 0x4012; //GIS信息
    public static final int COMM_ALARM_ALARMGPS = 0x1202;//GPS报警信息
    public static final int COMM_HFPD_ALARM = 0x6121; //高频图像特征识别检测报警(Json数据结构)
...
//2007-11-30 V211支持以下接口 //11
    ...
    public static class NET_DVR_GPSALARMINFO extends SDK_Structure {
        public byte[] byDeviceID = new byte[NAME_LEN];
        public NET_DVR_TIME_EX struGpsTime;
        public int dwLongitude;
        public int dwLatitude;
        public int iTimeZone;
        public int dwDirection;
        public short wSatellites;
        public short wPrecision;
        public int dwHeight;
        public int dwGPSSeq;
        public short wSpeed;
        public char[] sDirection = new char[2];
        public byte byLocateMode;
        public byte[] byRes = new byte[3];
    }
}
